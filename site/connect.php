<?php
	...
	*/
	...
	$db_pass			= 'tuhji717odda300U9t'; // Пароль базы данных
	$db_database		= 'Base'; //База данных
	
	$db_table       	= 'mcr_users'; //Таблица с пользователями
    ...
    $db_columnIp  		= 'ip_create'; //Колонка с IP пользователей
	
	$db_columnDatareg   = 'time_create'; // Колонка даты регистрации
	...
	$masterversion  	= '123'; //Мастер-версия лаунчера
	$protectionKey		= '1234567891'; 
	$key1               = "1234567891234561";  //16 Character Key Ключ пост запросов
	$key2               = "1234567891234561"; //16 Character  Key  Ключ пост запросов
